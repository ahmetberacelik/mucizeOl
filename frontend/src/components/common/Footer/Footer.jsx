        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 leading-relaxed max-w-md">
              ...
              her aile bir dostu arıyor.
            </p>
            <div className="flex gap-4">
              <a 
                href="#" 
                className="w-10 h-10 rounded-full bg-gray-700 hover:bg-primary-600 flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg"
                aria-label="Facebook"
              >
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-bold text-lg mb-4 text-white">Hızlı Linkler</h4>
            <ul className="space-y-3">
              <li>
                <Link to="/" className="text-gray-300 hover:text-primary-400 transition-colors duration-300 flex items-center gap-2 group">
                  <span className="w-0 group-hover:w-2 h-0.5 bg-primary-400 transition-all duration-300"></span>
                  Ana Sayfa
                </Link>
              </li>
              <li>
                <Link to="/about" className="text-gray-300 hover:text-primary-400 transition-colors duration-300 flex items-center gap-2 group">
                  <span className="w-0 group-hover:w-2 h-0.5 bg-primary-400 transition-all duration-300"></span>
                  Hakkımızda
                </Link>
              </li>
              ...
              <li>
                <Link to="/register" className="text-gray-300 hover:text-primary-400 transition-colors duration-300 flex items-center gap-2 group">
                  <span className="w-0 group-hover:w-2 h-0.5 bg-primary-400 transition-all duration-300"></span>
                  Kayıt Ol
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-300">
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:info@mucizeol.com" className="hover:text-primary-400 transition-colors duration-300">
                  info@mucizeol.com
                </a>
              </li>
              <li className="flex items-center gap-3">
        ...
        <div className="border-t border-gray-700 pt-8 mt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6 text-sm text-gray-400">
              ...
              <a href="#" className="hover:text-primary-400 transition-colors duration-300">Kullanım Koşulları</a>
            </div>
          </div>
        </div>
      </div>
