    ...
    return (
      <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
        <div className="flex items-center justify-center gap-3">
          ...
          <span className="text-gray-600 font-medium">Filtreler yükleniyor...</span>
        </div>
      </div>
    );
  }
    ...
    <div className="bg-white rounded-2xl shadow-xl p-6 mb-8 border border-gray-100">
      <div className="flex flex-wrap items-end gap-4">
        ...
        <div className="flex-1 min-w-[200px]">
          ...
          <select
            id="cityFilter"
            className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-primary-500 focus:ring-2 focus:ring-primary-200 transition-all duration-300 bg-white text-gray-700 font-medium hover:border-primary-300 cursor-pointer"
        ...
        <div className="flex-shrink-0">
          <button
            ...
            className="px-6 py-3 bg-gradient-to-r from-gray-100 to-gray-200 text-gray-700 font-semibold rounded-xl hover:from-gray-200 hover:to-gray-300 transition-all duration-300 shadow-md hover:shadow-lg transform hover:scale-105 border-2 border-gray-200 hover:border-gray-300 flex items-center gap-2"
          >
